...
7. implement reset feature where the enemies and tiles are spawned in after all do the enemies are defeated and the user allows the game to continue (use message box) 4/26/27
8. implement the UI for the game (pausing, wave over screen, buttons to lead to upgrade shop or next round, game over screen 
...
bool Game_Init(HWND hwnd)
{
    ...
    soundEffect = LoadSound(L"Blow Me Away.wav");
    if (soundEffect == NULL)
    {
        return false;
    }
